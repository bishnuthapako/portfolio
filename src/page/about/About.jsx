          ...
          <div className="p-2">
            <div data-aos="fade-right" data-aos-duration="2000" className="text-gray-300 my-3">
              <p className="text-justify leading-7 w-11/12 mx-auto">
                ...
                Frontend developer from two prestigious schools. I have honed
                my skills in a wide array of technologies, including JavaScript,
                ReactJs, TypeScript, Ruby on Rails, Bootstrap, and TailWind
                CSS. I love making innovative web apps and software that
                impress. My studies and projects have prepared me well for this
                career. I also enjoy nature, often going fishing and hiking,
                which helps me relax and stay refreshed for my coding work.
                Music is important to me too, inspiring and calming me. I'm
                proud of my professional skills and hobbies, always aiming to
                improve in all areas of my life.
              </p>
